...
!function(e,t){"object"==typeof exports&&"object"==typeof module?module.exports=t(require("es6-promise"),require("async"),require("axios"),require("memory-cache")):"function"==typeof define&&define.amd?define(["es6-promise","async","axios","memory-cache"],t):"object"==typeof exports?exports["pokedex-promise-v2"]=t(require("es6-promise"),require("async"),require("axios"),require("memory-cache")):e["pokedex-promise-v2"]=t(e["es6-promise"],e.async,e.axios,e["memory-cache"])}(this,function(e,t,o,i){return function(e){function t(i){if(o[i])return o[i].exports;var n=o[i]={exports:{},id:i,loaded:!1};return e[i].call(n.exports,n,n.exports,t),n.loaded=!0,n.exports}var o={};return t.m=e,t.c=o,t.p="",t(0)}([function(e,t,o){"use strict";function i(e){return e&&e.__esModule?e:{default:e}}function n(e,t){if(!(e instanceof t))throw new TypeError("Cannot call a class as a function")}var r="function"==typeof Symbol&&"symbol"==typeof Symbol.iterator?function(e){return typeof e}:function(e){return e&&"function"==typeof Symbol&&e.constructor===Symbol&&e!==Symbol.prototype?"symbol":typeof e},a=function(){function e(e,t){for(var o=0;o<t.length;o++){var i=t[o];i.enumerable=i.enumerable||!1,i.configurable=!0,"value"in i&&(i.writable=!0),Object.defineProperty(e,i.key,i)}}return function(t,o,i){return o&&e(t.prototype,o),i&&e(t,i),t}}(),s=o(7),u=i(s),c=o(5),m=i(c),g=o(6),f=i(g),l=o(4),y=o(1),p=o(3),v="undefined"==typeof Promise?o(2).Promise:Promise,d=function(){function e(t){var o=this;n(this,e),p.configurator.setPokedexConfiguration(t),m.default.forEach(function(e){o[e[0]]=function(t,o){if(t){if("number"==typeof t||"string"==typeof t)return(0,l.getJSON)(""+y.values.protocol+y.values.hostName+y.values.versionPath+e[1]+"/"+t+"/",o);if("object"===("undefined"==typeof t?"undefined":r(t))){var i=[];return new v(function(n,r){u.default.forEachOf(t,function(r){(0,l.getJSON)(""+y.values.protocol+y.values.hostName+y.values.versionPath+e[1]+"/"+r+"/",function(e){i.push(e),i.length===t.length&&(o&&o(i),n(i))})})})}}}}),f.default.forEach(function(e){o[e[0]]=function(t,o){return p.configurator.setRootEndpointConfiguration(t),(0,l.getJSON)(""+y.values.protocol+y.values.hostName+y.values.versionPath+e[1]+"?limit="+y.values.limit+"&offset="+y.values.offset,o)}})}return a(e,[{key:"resource",value:function(e){return"string"==typeof e?(0,l.getJSON)(e):"object"===("undefined"==typeof e?"undefined":r(e))?v.all(e.map(function(e){return(0,l.getJSON)(e)})):"String or Array is required"}}]),e}();e.exports=d},function(e,t){"use strict";Object.defineProperty(t,"__esModule",{value:!0});var o={};o.protocol="http",o.hostName="://pokeapi.co",o.versionPath="/api/v2/",o.offset=0,o.limit=1e5,o.timeout=2e4,o.cacheLimit=1e9,o.setProtocol=function(e){o.protocol=e},o.setHostName=function(e){o.hostName="://"+e},o.setVersionPath=function(e){o.versionPath=e},o.setOffset=function(e){o.offset=e-1},o.setLimit=function(e){o.limit=e+1},o.setTimeout=function(e){o.timeout=e},o.setCacheLimit=function(e){o.cacheLimit=e},t.values=o},function(e,t){e.exports=require("es6-promise")},function(e,t,o){"use strict";Object.defineProperty(t,"__esModule",{value:!0}),t.configurator=void 0;var i=o(1),n={};n.setPokedexConfiguration=function(e){e&&(e.hasOwnProperty("protocol")&&i.values.setProtocol(e.protocol),e.hasOwnProperty("hostName")&&i.values.setHostName(e.hostName),e.hasOwnProperty("versionPath")&&i.values.setVersionPath(e.versionPath),e.hasOwnProperty("timeout")&&i.values.setTimeout(e.timeout),e.hasOwnProperty("cacheLimit")&&i.values.setCacheLimit(e.cacheLimit))},n.setRootEndpointConfiguration=function(e){e&&(e.offset&&i.values.setOffset(e.offset),e.limit&&i.values.setLimit(e.limit))},t.configurator=n},function(e,t,o){"use strict";function i(e){return e&&e.__esModule?e:{default:e}}Object.defineProperty(t,"__esModule",{value:!0}),t.getJSON=void 0;var n=o(8),r=i(n),a=o(9),s=i(a),u=o(1),c="undefined"==typeof Promise?o(2).Promise:Promise,m=function(e,t){var o=s.default.get(e);if(null!==o)return new c(function(e,i){t&&t(o,!1),e(o)});var i={baseURL:""+u.values.protocol+u.values.hostName+"/",timeout:u.values.timeout};return r.default.get(e,i).catch(function(e){if(!t)throw e;t("error",e)}).then(function(o){if(o)if(void 0!==o.statusCode&&200!==o.statusCode){if(!t)throw o;t("error",o)}else{if(o=o.data,u.values.cacheLimit>0&&s.default.put(e,o,u.values.cacheLimit),!t)return o;t(o,!1)}})};t.getJSON=m},function(e,t){e.exports=[["getBerryByName","berry"],["getBerryFirmnessByName","berry-firmness"],["getBerryFlavorByName","berry-flavor"],["getContestTypeByName","contest-type"],["getContestEffectById","contest-effect"],["getSuperContestEffectById","super-contest-effect"],["getEncounterMethodByName","encounter-method"],["getEncounterConditionByName","encounter-condition"],["getEncounterConditionValueByName","encounter-condition-value"],["getEvolutionChainById","evolution-chain"],["getEvolutionTriggerByName","evolution-trigger"],["getGenerationByName","generation"],["getPokedexByName","pokedex"],["getVersionByName","version"],["getVersionGroupByName","version-group"],["getItemByName","item"],["getItemAttributeByName","item-attribute"],["getItemCategoryByName","item-category"],["getItemFlingEffectByName","item-fling-effect"],["getItemPocketByName","item-pocket"],["getMachineById","machine"],["getMoveByName","move"],["getMoveAilmentByName","move-ailment"],["getMoveBattleStyleByName","move-battle-style"],["getMoveCategoryByName","move-category"],["getMoveDamageClassByName","move-damage-class"],["getMoveLearnMethodByName","move-learn-method"],["getMoveTargetByName","move-target"],["getLocationByName","location"],["getLocationAreaByName","location-area"],["getPalParkAreaByName","pal-park-area"],["getRegionByName","region"],["getAbilityByName","ability"],["getCharacteristicById","characteristic"],["getEggGroupByName","egg-group"],["getGenderByName","gender"],["getGrowthRateByName","growth-rate"],["getNatureByName","nature"],["getPokeathlonStatByName","pokeathlon-stat"],["getPokemonByName","pokemon"],["getPokemonColorByName","pokemon-color"],["getPokemonFormByName","pokemon-form"],["getPokemonHabitatByName","pokemon-habitat"],["getPokemonShapeByName","pokemon-shape"],["getPokemonSpeciesByName","pokemon-species"],["getStatByName","stat"],["getTypeByName","type"],["getLanguageByName","language"]]},function(e,t){e.exports=[["getEndpointsList",""],["getBerriesList","berry/"],["getBerriesFirmnesssList","berry-firmness/"],["getBerriesFlavorsList","berry-flavor/"],["getContestTypesList","contest-type/"],["getContestEffectsList","contest-effect/"],["getSuperContestEffectsList","super-contest-effect/"],["getEncounterMethodsList","encounter-method/"],["getEncounterConditionsList","encounter-condition/"],["getEncounterConditionValuesList","encounter-condition-value/"],["getEvolutionChainsList","evolution-chain/"],["getEvolutionTriggersList","evolution-trigger/"],["getGenerationsList","generation/"],["getPokedexsList","pokedex/"],["getVersionsList","version/"],["getVersionGroupsList","version-group/"],["getItemsList","item/"],["getItemAttributesList","item-attribute/"],["getItemCategoriesList","item-category/"],["getItemFlingEffectsList","item-fling-effect/"],["getItemPocketsList","item-pocket/"],["getMachinesList","machine/"],["getMovesList","move/"],["getMoveAilmentsList","move-ailment/"],["getMoveBattleStylesList","move-battle-style/"],["getMoveCategoriesList","move-category/"],["getMoveDamageClassesList","move-damage-class/"],["getMoveLearnMethodsList","move-learn-method/"],["getMoveTargetsList","move-target/"],["getLocationsList","location/"],["getLocationAreasList","location-area/"],["getPalParkAreasList","pal-park-area/"],["getRegionsList","region/"],["getAbilitiesList","ability/"],["getCharacteristicsList","characteristic/"],["getEggGroupsList","egg-group/"],["getGendersList","gender/"],["getGrowthRatesList","growth-rate/"],["getNaturesList","nature/"],["getPokeathlonStatsList","pokeathlon-stat/"],["getPokemonsList","pokemon/"],["getPokemonColorsList","pokemon-color/"],["getPokemonFormsList","pokemon-form/"],["getPokemonHabitatsList","pokemon-habitat/"],["getPokemonShapesList","pokemon-shape/"],["getPokemonSpeciesList","pokemon-species/"],["getStatsList","stat/"],["getTypesList","type/"],["getLanguagesList","language/"]]},function(e,t){e.exports=require("async")},function(e,t){e.exports=require("axios")},function(e,t){e.exports=require("memory-cache")}])});
},{"async":5,"axios":6,"es6-promise":1,"memory-cache":3}],5:[function(require,module,exports){
(function (process,global){
(function (global, factory) {
...
},{"_process":31}],6:[function(require,module,exports){
...
},{"../core/createError":14,"./../core/settle":17,"./../helpers/btoa":21,"./../helpers/buildURL":22,"./../helpers/cookies":24,"./../helpers/isURLSameOrigin":26,"./../helpers/parseHeaders":28,"./../utils":30,"_process":31}],8:[function(require,module,exports){
'use strict';
...
},{"./adapters/http":7,"./adapters/xhr":7,"./helpers/normalizeHeaderName":27,"./utils":30,"_process":31}],20:[function(require,module,exports){
'use strict';
...
},{"./helpers/bind":20,"is-buffer":2}],31:[function(require,module,exports){
...
//    });
var poke = P.getPokemonByName('bulbasaur') // with Promise
.then(function (response) {
  console.log(response);
  console.log(response.stats[0].stat.name);
  $("#pokename").append(response.name);
  //  $("#gender").append(response.);
...
},{"./../src/js/tamagotchi.js":32,"pokedex-promise-v2":4}]},{},[33]);
